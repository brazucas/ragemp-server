...
interface PlayerMp extends EntityMp {
	...
	notify(message:string, flashing?:boolean, textColor?:number, bgColor?:number, flashColor?:RGBA): void;
	notifyWithPicture(title:string, sender:string, message:string, notifPic:string, icon?:number, flashing?:boolean, textColor?:number, bgColor?:number, flashColor?:RGBA): void;
